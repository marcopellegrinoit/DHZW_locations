...
# Read locations
setwd(this.dir())
setwd('location_folders/home/data')
...
setwd(this.dir())
setwd('location_folders/work/data')
df_work <- read.csv('work_DHZW.csv')
colnames(df_work)

setwd(this.dir())
setwd('location_folders/schools/data')
...
setwd(this.dir())
setwd('location_folders/shopping/data')
df_shoppings <- read.csv('shopping_DHZW.csv')
colnames(df_shoppings)

setwd(this.dir())
setwd('location_folders/sport/data')
